...
**Wiring:** `main.js` automatically adds click handlers to `.arch-component` elements. Put the explanation in `data-desc`; do not add an inline `onclick`.
...
**Wiring:** Call `showLayer(layerId, this)` from each tab. Keep layer IDs unique within the demo. Set `data-description` on each tab to update `.layer-description`.

**HTML:**
```html
<div class="layer-demo">
  <div class="layer-tabs">
    <button class="layer-tab active"
            data-description="This is the raw HTML structure."
            onclick="showLayer('layer-html', this)">HTML</button>
    <button class="layer-tab"
            data-description="CSS adds layout, spacing, and visual hierarchy."
            onclick="showLayer('layer-css', this)">+ CSS</button>
    <button class="layer-tab"
            data-description="JavaScript adds behavior and interaction."
            onclick="showLayer('layer-js', this)">+ JS</button>
  </div>
